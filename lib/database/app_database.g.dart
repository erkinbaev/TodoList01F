...
class $TodosTable extends Todos with TableInfo<$TodosTable, Todo> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, title, isFinished, date];
  @override
...
class Todo extends DataClass implements Insertable<Todo> {
  ...
  Todo copyWith({int? id, String? title, bool? isFinished, String? date}) =>
      Todo(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, title, isFinished, date);
  @override
